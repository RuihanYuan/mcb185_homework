...
#check if this is closer to red, green or blue
#(any color fromt the data/tsv files)
#ex: abs(r1-r_ref)+abs(g1-g_ref)+abs(b1-b_ref), 
#and find the minimum dist, compare through the list of dif
